...
class FakeFcmTokenRepository(
    ...
    private val _markedTokens = mutableListOf<String>()
    val markedTokens: List<String> get() = _markedTokens

    private val _registeredTokens = mutableListOf<String>()
    val registeredTokens: List<String> get() = _registeredTokens
