package com.anddd.nevera.feature.auth.main.google

import android.app.Activity
import androidx.credentials.CredentialManager
import androidx.credentials.GetCredentialRequest
import androidx.credentials.GetCredentialResponse
import com.anddd.nevera.feature.auth.BuildConfig
...
class GoogleAuthClient @Inject constructor() {
    ...
    private fun extractIdToken(response: GetCredentialResponse): String {
        return try {
            GoogleIdTokenCredential.createFrom(data = response.credential.data).idToken
